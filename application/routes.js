...
const dossierContrôleurs = chemin.join(__dirname, "./contrôleurs")
const chargerModules = require("./modules/chargerModules")
const contrôleurs = chargerModules(dossierContrôleurs)
